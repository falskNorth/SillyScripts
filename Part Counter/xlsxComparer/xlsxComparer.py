...
# TODO:
#  ADD A THING THAT LETS ME DOUBLE THE VALUES OF SPECIFIC SHEETS
#  INCLUDE UNITS SOMEHOW AND DOUBLE CHECK THE FLOATS ROUND UP
#  INCLUDE CELL LETTER/NUMBER
#  INCLUDE WHAT SHEET IT CAME FROM
...
if __name__ == "__main__":
    ...
    count_duplicates(folder_path, output_filename)


## CODE GRAVEYARD:

# Ensure total_quantity is a string for concatenation
# if isinstance(total_quantity, int):
#     total_quantity = str(total_quantity)  #  Convert to string if it's an integer